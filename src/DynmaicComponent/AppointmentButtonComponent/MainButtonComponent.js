...
return (
    <div className='MainButton'>
        <MainButton className='appoint' onClick={props.onclick} disabled={props.disabled}
            font={props.font} back={props.back} hoverfont={props.hoverfont} hoverback={props.hoverback}>
            {props.child}
        </MainButton>
    </div>
)
